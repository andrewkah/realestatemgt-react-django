...
class Property(models.Model):
    ...
    category = models.CharField(max_length=20, choices=PropertyCategory.choices, default=PropertyCategory.RENT)
    ...
    # Ownership
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='property')
    owned_by_agent = models.ForeignKey(Agent, on_delete=models.SET_NULL, null=True, blank=True, related_name='agent_owns')
    # timestamps
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:
            ...
            if self.status == PropertyStatus.AVAILABLE and original.status != self.status:                
