...
class MaintenanceRequestViewSet:
    ...
    def get_queryset(self):
        return (
            MaintenanceRequest.objects.filter(user=self.request.user)
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid(raise_exception=True):
            try:
                request_arr = service.create_request(
    ...
    def update(self, request, *args, **kwargs):
        ...
        if (
            ...
            or maintenance_request_instance.created_by != self.request.user
        ):
            return Response(
                {
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            return Response(
                service.update_maintenance_request(request, pk),
